		...
		var jsc = {
			...
			pub: function (targetElement, opts) {
				...
				this.setPreviewElementBg = function (color) {
					...
					var backgrounds = [];
					if (!color) {
						backgrounds.push({ image: "none", position: "left top", size: "auto", repeat: "no-repeat", origin: "padding-box" });
					} else {
						backgrounds.push({
				...
				function drawPicker() {
					...
					p.asldM.style.width =
						THIS.sliderSize + 2 * controlPadding + 2 * THIS.controlBorderWidth + Math.max(0, THIS.padding - controlPadding) + "px";
						...
						for (var c = 0; c < pickerDims.palette.cols && si < THIS._palette.length; c++, si++) {
							...
							sw.style.left =
								(pickerDims.palette.cols <= 1
									? 0
									: Math.round(10 * (c * ((pickerDims.contentW - pickerDims.palette.cellW) / (pickerDims.palette.cols - 1)))) / 10) + "px";
				...
				function redrawSld() {
					...
					if (sldChannel) {
						...
						jsc.picker.sldPtrOB.style.top =
							y - (2 * THIS.pointerBorderWidth + THIS.pointerThickness) - Math.floor(jsc.pub.sliderInnerSpace / 2) + "px";
					}
					jsc.picker.asldGrad.draw(THIS.sliderSize, THIS.height, THIS.toHEXString());
				}
				function redrawASld() {
